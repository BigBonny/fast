      ...
      <div className="px-5 pt-5">
        <div className="bg-white rounded-2xl p-4 flex items-center gap-4 shadow-sm border border-gray-100 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Activer les notifications</p>
          </div>
        </div>

        <div className="space-y-2">
          {options.map((opt) => (
            <div key={opt.label} className="bg-white rounded-2xl p-4 flex items-center gap-3 shadow-sm border border-gray-100">
              ...
              <div className={`w-10 h-6 rounded-full p-1 transition-colors ${opt.value ? "bg-emerald-500" : "bg-gray-300"}`}>
