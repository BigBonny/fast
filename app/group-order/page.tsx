    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white px-5 py-4 flex items-center gap-3 border-b border-gray-100 sticky top-0 z-20">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-bold text-gray-900">Commande de groupe</h1>
        </div>
      </div>
      ...
      <div className="px-5 pt-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
          <h3 className="font-bold text-gray-900 mb-4">Rejoindre un groupe</h3>
          <div className="flex gap-2">
            <input
              type="text"
              placeholder="Entrez le code du groupe"
              className="flex-1 bg-gray-50 rounded-xl px-4 py-3 text-sm border-0 focus:ring-2 focus:ring-violet-500"
            />
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Groupe actif</h3>
